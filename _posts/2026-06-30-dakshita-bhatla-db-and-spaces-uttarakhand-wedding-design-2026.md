...
tags:
  - Wedding Planning
image: /assets/images/posts/tbl-banner-db-spaces.png
featured: false
meta_title: "Dakshita Bhatla, DB and Spaces: Building India's Most Sought-After
  Destination Wedding Firm From Uttarakhand"
excerpt: She built one of India's most recognised luxury wedding design firms
  from the mountains, not despite them. Dakshita Bhatla on designing with the
  landscape, planning for two public weddings, and the monochromatic wedding she
  still wants to build.
instagram_url: https://www.instagram.com/dbspaces/?hl=en
---
